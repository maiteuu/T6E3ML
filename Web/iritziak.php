<?php
session_start();
if (!isset($_SESSION["tipoUsuario"]) || $_SESSION["tipoUsuario"] !== 'presidentea') {
...
<body>
    ...
    <main>
        <h1 class="iritzi-izenburua">ERABILTZAILEEN IRITZIAK</h1>
        ...
        if (file_exists($fitxategia)) {
            ...
            if (@$xml->load($fitxategia)) {
                ...
                echo '<p class="iritzi-errorea">Errorea: Ezin izan da iritzien fitxategia kargatu.</p>';
            }
        } else {
