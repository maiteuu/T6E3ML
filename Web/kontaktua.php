        ...
        <div class="formulario-txartela">
            ...
            <form action="gorde.php" method="POST" class="iradokizun-form">
                ...
                <div class="input-errenkada">
                    <textarea name="mezua" class="testu-eremua" placeholder="Idatzi zure feedback-a hemen..."
                        required></textarea>
                </div>
                ...
                <div class="input-grid-2x2">
                    <div class="input-taldea-iradokizun">
                        ...
                        <input type="text" name="izena" id="izena" class="iradokizun-input" placeholder="Adibidea: juan"
                            required>
                    </div>

                    <div class="input-taldea-iradokizun">
                        <label for="abizena" class="etiketa-beltza">Abizena</label>
                        <input type="text" name="abizena" id="abizena" class="iradokizun-input"
                            placeholder="Adibidea: agirre" required>
                    </div>

                    <div class="input-taldea-iradokizun">
                        <label for="email" class="etiketa-beltza">Posta</label>
                        <input type="email" name="email" id="email" class="iradokizun-input"
                            placeholder="Adibidea: juanagirre@gmail.com" required>
                    </div>

                    <div class="input-taldea-iradokizun">
                        <label for="telefonoa" class="etiketa-beltza">Telefonoa</label>
                        <input type="text" name="telefonoa" id="telefonoa" class="iradokizun-input"
                            placeholder="Adibidea: 987654321" pattern="[0-9]{9}" required>
                    </div>
                </div>
